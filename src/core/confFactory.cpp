...
constexpr auto CONF_KEY_CHANNEL_ROUTING_X             = "channel_routing_x";
constexpr auto CONF_KEY_CHANNEL_ROUTING_Y             = "channel_routing_y";
constexpr auto CONF_KEY_CHANNEL_ROUTING_W             = "channel_routing_w";
constexpr auto CONF_KEY_CHANNEL_ROUTING_H             = "channel_routing_h";
...
Conf parse_(std::ifstream& ifs)
{
	...
	conf.channelRoutingBounds.x     = j.value(CONF_KEY_CHANNEL_ROUTING_X, conf.channelRoutingBounds.x);
	conf.channelRoutingBounds.y     = j.value(CONF_KEY_CHANNEL_ROUTING_Y, conf.channelRoutingBounds.y);
	conf.channelRoutingBounds.w     = j.value(CONF_KEY_CHANNEL_ROUTING_W, conf.channelRoutingBounds.w);
	conf.channelRoutingBounds.h     = j.value(CONF_KEY_CHANNEL_ROUTING_H, conf.channelRoutingBounds.h);
...
bool serialize(const Conf& conf)
{
	...
	j[CONF_KEY_CHANNEL_ROUTING_X]             = conf.channelRoutingBounds.x;
	j[CONF_KEY_CHANNEL_ROUTING_Y]             = conf.channelRoutingBounds.y;
	j[CONF_KEY_CHANNEL_ROUTING_W]             = conf.channelRoutingBounds.w;
	j[CONF_KEY_CHANNEL_ROUTING_H]             = conf.channelRoutingBounds.h;
