...
constexpr auto  G_DEFAULT_MIDI_PORT_IN        = "";
constexpr auto  G_DEFAULT_MIDI_PORT_OUT       = "";
...
constexpr auto CONF_KEY_MIDI_PORT_OUT_NAME            = "midi_port_out_name";
constexpr auto CONF_KEY_MIDI_PORT_IN_NAME             = "midi_port_in_name";
