...
struct ChannelShared final
{
	...
	/* rewinding
	Tells whether the sample must be rewound during rendering, e.g. when the
	sequencer goes back to 0 and the Sample Channel is playing in loop mode. */

	bool rewinding = false;

	/* generated
	Numbers of frames generated by the renderer. Might be different from tracker
	if pitch != 1.0. Shared as it must be persistent across swaps. */
