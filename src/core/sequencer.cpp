...
TimeSignature Sequencer::getTimeSignature() const { return m_model.get().sequencer.getTimeSignature(); }
...
{
	return (60.0f * getTimeSignature().beats) / (recordedFrames / static_cast<float>(m_currentSampleRate));
}
