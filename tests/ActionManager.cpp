...
TEST_CASE("ActionRecorder")
{
	...
	SECTION("Test record")
	{
		...
		const Action a1 = ar.rec_DEPR_(channelID1, Scene{0}, f1, e1);
		const Action a2 = ar.rec_DEPR_(channelID1, Scene{0}, f2, e2);
		...
		SECTION("Test clear actions by channel")
		{
			...
			ar.rec_DEPR_(channelID2, Scene{0}, f1, e1);
			ar.rec_DEPR_(channelID2, Scene{0}, f2, e2);
