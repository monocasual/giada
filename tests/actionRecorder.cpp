...
TEST_CASE("ActionRecorder")
{
	...
	channelFactory::Data channel1 = channelFactory::create(channelID1, ChannelType::SAMPLE, 0, 1024, Resampler::Quality::LINEAR, false);
	channelFactory::Data channel2 = channelFactory::create(channelID2, ChannelType::SAMPLE, 0, 1024, Resampler::Quality::LINEAR, false);
